...
export const ModalUsuarioEditar = ({ usuario, open, setOpen, setActualizar }: Props) => {
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="w-1/2 max-w-md mx-auto shadow-xl border-green-500 overflow-hidden p-0">
          <DialogHeader className="bg-gradient-to-r from-green-500 to-green-600 text-white space-y-1 pb-6 rounded-t-lg">
            <DialogTitle className="text-2xl font-bold flex items-center gap-2 m-4"><Pencil className="h-6 w-6" /> Edicion de usuario</DialogTitle>
          ...
          <div className="p-6 pt-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="nombre" className="text-sm font-medium text-green-800">Nombre</Label>
                <Input
                  id="nombre"
              ...
              <div className="space-y-2">
                <Label htmlFor="apellidos" className="text-sm font-medium text-green-800">Apellidos</Label>
                <Input
                  id="apellidos"
              ...
              <div className="space-y-2">
                <Label htmlFor="username" className="text-sm font-medium text-green-800">Nombre de usuario</Label>
                <Input
                  id="username"
              ...
              <div className="space-y-2">
                <Label htmlFor="rol" className="text-sm font-medium text-green-800">Rol</Label>
                <select
