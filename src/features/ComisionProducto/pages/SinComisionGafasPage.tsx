...
export const SinComisionGafasPage = () => {
  ...
  const {
    ...
    queryKey: ["combinacion-sin-comision-producto-gafas", page],
    queryFn: () => obtenerSinComisionProductoGafa(),
    ...
    <div className="mx-auto flex flex-col gap-4">
      ...
      {isLoading ? (
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {filtrarCombinacion.length > 0 && (filtrarCombinacion.map((combinacion: Datum,index: number) => (
